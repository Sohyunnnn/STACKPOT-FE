import { contentContainer, introductionStyle, nicknameStyle, profileContainer, profileStyle } from "./UserPageProfile.style";
...
const UserPageProfile: React.FC<UserPageProfileProps> = ({ profileImage, nickname, introduction, temperature }: UserPageProfileProps) => {
